...
<div class="content_product_check">
    ...
    * Khuyến mãi tặng thêm quà cho một sản phẩm chỉ có thể được
    áp dụng khi chọn từ các tùy chọn (nếu mua riêng lẻ, không thể tặng thêm quà)



    * Không thể trả lại một phần sau khi đặt hàng các mặt hàng khuýen mãi hoặc các mặt hàng theo gói
    (chỉ có thể trả lại toàn bộ các mặt hàng theo gói(không thể trả lại theo sản phẩm))
