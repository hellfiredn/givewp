	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		<div id="review_form_wrapper">
			...
			<div class="product-rating-summary">
				<div class="rating-overview">
					...
					<div class="average-rating">
						<span class="rating-number"><?php echo $average_rating > 0 ? number_format($average_rating, 1) : '0.0'; ?></span>
					</div>
					<div class="review-count">
						<span><?php echo $review_count; ?> Previews</span>
					</div>
			...
			<div id="review_form" class="col-inner">
				...
				$comment_form['comment_field'] .= '<p class="comment-form-comment"><textarea id="comment" name="comment" placeholder="Hãy cho tôi biết đánh giá của bạn" cols="45" rows="8" required></textarea></p>';
